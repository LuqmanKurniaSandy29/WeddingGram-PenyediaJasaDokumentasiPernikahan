...
const Footer = () => {
  ...
  return (
    <div>
      <div bg="light" variant="light">
        <Container className="d-flex align-item-center justify-content-center">
          <div style={{ width: "100%" }}>
            <Row className="my-5">
              <Col lg={4} md={5} sm={6}>
                <h5 className="text-left font-weight-bold">Abuot Us</h5>
              ...
              <Col lg={3} md={3} sm={6} className="text-left">
                <h5 className="font-weight-bold">Our Product</h5>
              ...
              <Col lg={3} md={3} sm={6}>
                <h5 className="text-left font-weight-bold">Why Should We?</h5>
              ...
              <Col lg={2} md={1} sm={6} className="text-left">
                <h5 className="font-weight-bold">Our SNS</h5>
                <ul className="list-unstyled">
      ...
      <div className="custom-bg footer-height py-3 text-center">
        <Container>
